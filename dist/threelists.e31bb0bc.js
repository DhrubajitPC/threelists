...
var list1, mainList, list2, btn1, btn2, feed1Timer, feed2Timer, classMap, selectedItem;
...
window.onload = function () {
  ...
  classMap = new Map([[list1, "list1-item"], [mainList, "mainList-item"], [list2, "list2-item"]]);
};
...
function handleItemClick(ev) {
  ...
  node.style.left = itemDim.left - parseInt(getComputedStyle(item).marginLeft, 10) + "px";
  node.style.top = itemDim.top - parseInt(getComputedStyle(item).marginTop, 10) + "px";
  item.remove();
  selectedItem = node;
...
function animate() {
  var dim = mainList.getBoundingClientRect();
...
function afterTransition(ev) {
  var selectedItem = ev.target;
  selectedItem.classList.remove("floating");
  selectedItem.remove();
  mainList.prepend(selectedItem);
}
},{"lorem-ipsum":"node_modules/lorem-ipsum/dist/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/threelists.e31bb0bc.js.map